#python 4.2.4_1_Cross_Model_Unconnected.py > 4.2.4_1_Cross_Model_Unconnected.log 2>&1 &
...
if __name__ == "__main__":
    ...
    model_files = [
        "ResNet1D_SupConLoss_train_raw_unconnected_final.pth",
        "ResNet1D_SupConLoss_train_unconnected_hardware_HydroCe_final.pth",
        "ResNet1D_SupConLoss_train_unconnected_hardware_BioSemi_final.pth",
        "ResNet1D_SupConLoss_train_unconnected_hardware_Geodisi_final.pth"
    ]
    ...
    with open("evaluation_results_unconnected.json", "w") as f:
