#python3 Trainer-EER_trainsets_headset.py --chosen_loss SupConLoss --cuda_devices 0 --train Emotive > out1.log 2>&1 &
#python3 Trainer-EER_trainsets_headset.py --chosen_loss SupConLoss --cuda_devices 1 --train DSIVR300 > out2.log 2>&1 &
#python3 Trainer-EER_trainsets_headset.py --chosen_loss SupConLoss --cuda_devices 2 --train Muse > out3.log 2>&1 &
...
if __name__ == '__main__':
    train_ds = EEGDataset(os.path.join(data_dir, f"train_raw.h5"))
    ...
    for name in models_to_run:
        ...
        writer.close()
        torch.save(model.state_dict(), os.path.join('model_3', f"{name}_{chosen_loss}_{headset}_final.pth"))
