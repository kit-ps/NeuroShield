#python3 Trainer-EER.py --chosen_loss SupConLoss --cuda_devices 0 > out1.log 2>&1 &
#python3 Trainer-EER.py --chosen_loss LiftedStructureLoss --cuda_devices 1 > out2.log 2>&1 &
#python3 Trainer-EER.py --chosen_loss SoftTripleLoss --cuda_devices 2 > out3.log 2>&1 &
#python3 Trainer-EER.py --chosen_loss ArcFaceLoss --cuda_devices 3 > out4.log 2>&1 &
#python3 Trainer-EER.py --chosen_loss TripletMarginLoss --cuda_devices 0 > out5.log 2>&1 &
...
if __name__ == '__main__':
    train_ds = EEGDataset(os.path.join(data_dir, f"train_{feature}.h5"))
    val_ds   = EEGDataset_valid(os.path.join(data_dir, f"valid_{feature}.h5"))
        ...
        for epoch in range(1, num_epochs+1):
            ...
            if val_loss < best_val_loss and epoch > 25:
                ...
                torch.save(model.state_dict(),
                           os.path.join('model_3', f"{name}_{chosen_loss}_best.pth"))    
        writer.close()
        torch.save(model.state_dict(), os.path.join('model_3', f"{name}_{chosen_loss}_final.pth"))
